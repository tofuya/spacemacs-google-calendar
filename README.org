...
This layer provides a helper function
~google-calendar-define-open-commands~ which defines interactive
commands to open calendar org files based on
~google-calendar-calendars~.

After calling this function, commands with the following naming
...
(spacemacs/set-leader-keys
  "a g t" #'google-calendar-open-timeblocks
  "a g d" #'google-calendar-open-fixed)
#+end_src

Note:

~google-calendar-define-open-commands~ must be called after
~google-calendar-calendars~ is defined.
